...
class quyusan : public CDialogEx
{
	DECLARE_DYNAMIC(quyusan)

public:
	quyusan(CWnd* pParent = NULL);   // 标准构造函数
	virtual ~quyusan();

// 对话框数据
#ifdef AFX_DESIGN_TIME
	enum { IDD = IDD_QUYUSAN_DIALOG };
#endif
...
public:
	...
	double m_double11;
	double m_double12;
	afx_msg void OnBnClickedQusanfenButton();
