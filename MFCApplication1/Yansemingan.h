...
class Yansemingan : public CDialogEx
{
	DECLARE_DYNAMIC(Yansemingan)

public:
	Yansemingan(CWnd* pParent = NULL);   // 标准构造函数
	virtual ~Yansemingan();

// 对话框数据
	enum { IDD = IDD_YANSEMINGAN_DIALOG };
...
public:
	...
	afx_msg void OnBnClickedQufenButton();
