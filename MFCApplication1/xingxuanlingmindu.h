...
class xingxuanlingmindu : public CDialogEx
{
	DECLARE_DYNAMIC(xingxuanlingmindu)

public:
	xingxuanlingmindu(CWnd* pParent = NULL);   // 标准构造函数
	virtual ~xingxuanlingmindu();

// 对话框数据
#ifdef AFX_DESIGN_TIME
	enum { IDD = IDD_XINGXUANLINGMINDU_DIALOG };
#endif
