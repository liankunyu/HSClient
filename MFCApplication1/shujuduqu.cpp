...
void shujuduqu::OnBnClickedButton1()
{
	...
	if (cstr==L"通道1前相机")
	{
		...
		GetDlgItem(IDC_BUTTON1)->SetWindowText(L"通道1后相机");
	}
	if (cstr == L"通道1后相机")
	{
		xiangjixuanze = 34;
		...
		GetDlgItem(IDC_BUTTON1)->SetWindowText(L"通道2前相机");
	}	
	if (cstr == L"通道2前相机")
	{
		xiangjixuanze = 35;
		...
		GetDlgItem(IDC_BUTTON1)->SetWindowText(L"通道2后相机");
	}	
	if (cstr == L"通道2后相机")
	{
		xiangjixuanze = 36;
		...
		GetDlgItem(IDC_BUTTON1)->SetWindowText(L"通道3前相机");
	}	
	if (cstr == L"通道3前相机")
	{
		xiangjixuanze = 37;
		...
		GetDlgItem(IDC_BUTTON1)->SetWindowText(L"通道3后相机");
	}	
	if (cstr == L"通道3后相机")
	{
		xiangjixuanze = 38;
		...
		GetDlgItem(IDC_BUTTON1)->SetWindowText(L"通道4前相机");
	}	
	if (cstr == L"通道4前相机")
	{
		xiangjixuanze = 39;
		...
		GetDlgItem(IDC_BUTTON1)->SetWindowText(L"通道4后相机");
	}	
	if (cstr == L"通道4后相机")
	{
		xiangjixuanze = 40;
