...
CString server_IP=L"127.0.0.1";             //服务器IP
CString server_Port=L"9999";             //服务器端口号
int SWlang=0;                    //用于判断是否进行语言切换
string m_Tip="num6601";
string m_Tip2="num6801";    //通过这个全局变量向消息框传入不同的变量值，然后通过XML查询显示不同的消息，为了多语言
int m_Retip=0;     //提示框的返回值